...
class phlebotomistValidate {
  static createPhlebotomist = async (req, res, next) => {
    ...
    if (error) {
      ...
      const result = await phlebotomistModel.findOne({
  ...
  static patchPhlebotomist = async (req, res, next) => {
    const validateSchema = Joi.object().keys({
      email: Joi.string()
        .email()
        .empty()
...
export default phlebotomistValidate;
